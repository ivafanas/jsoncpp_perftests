...
COMMON_GENERATE_TEST_CASE(Reader_Astros,      json_example_astros,       run_reader);
...
COMMON_GENERATE_TEST_CASE(Reader_Chinaidp,    json_example_china_idp,    run_reader);
...
COMMON_GENERATE_TEST_CASE(Reader_Gzip,        json_example_gzip,         run_reader);
